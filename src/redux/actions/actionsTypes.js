...
export const REGISTRATION_FORM_ACTIONS = {
    SET_REGISTRATION_FORM_FIELD_VALUE: 'SET_REGISTRATION_FORM_FIELD_VALUE',
    SET_REGISTRATION_FORM_FIELD_ERROR: 'SET_REGISTRATION_FORM_FIELD_ERROR',
    VALIDATE_REGISTRATION_FORM_FIELD: 'VALIDATE_REGISTRATION_FORM_FIELD',
    CLEAR_REGISTRATION_FORM: 'CLEAR_REGISTRATION_FORM',
}

export const RESET_PASSWORD_FORM_ACTIONS = {
    SET_RESET_PASSWORD_FORM_FIELD_VALUE: 'SET_RESET_PASSWORD_FORM_FIELD_VALUE',
    SET_RESET_PASSWORD_FORM_FIELD_ERROR: 'SET_RESET_PASSWORD_FORM_FIELD_ERROR',
    VALIDATE_RESET_PASSWORD_FORM_FIELD: 'VALIDATE_RESET_PASSWORD_FORM_FIELD',
